...
class test_Place(test_basemodel):
    ...
    def test_user_id(self):
        """ testing user_id attribute of place"""
        new = self.value()
    ...
    def test_description(self):
        """test place attr of description"""
        new = self.value()
    ...
    def test_number_rooms(self):
        """ test number of rooms atrribute of place"""
        new = self.value()
    ...
    def test_number_bathrooms(self):
        """ test number of bathrooms attributes"""
        new = self.value()
